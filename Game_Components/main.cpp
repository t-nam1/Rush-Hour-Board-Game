...
Let the urban odyssey begin!
    ...
    for (char c : gameDescription) { // Display game description
        cout << c;
        cout.flush();
    ...
    while (playAgain) { // Loop to play the game again
        ...
        auto start = high_resolution_clock::now(); // hold the start time of the game
        int moves = 0;
    ...
    cin >> answer;
        ...
        else if (answer == "2") { // Display leaderboard
            // Display leaderboard
            cout << "\nLeaderboard:" << endl;
